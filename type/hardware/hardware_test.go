...
func TestHardwareFields(t *testing.T) {
	...
	// Note: The current implementation doesn't expose hardware fields directly
	// because the common package expects _items structure, but hardware has flat structure
